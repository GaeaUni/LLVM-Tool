...
class BuildSettingParser:
    def __init__(self, project_path):
        self.build_setting_json = self.get_build_settings_json(project_path)[
            0]['buildSettings']

    def get_build_settings_json(self, project_path):
        cmd = "xcodebuild -json  -configuration Debug -showBuildSettings -project {0}".format(
            project_path)
